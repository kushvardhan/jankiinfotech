...
const defaultSEO = {
  ...
  description: 'JankiInfotech provides world-class web development, mobile apps, cloud solutions, and professional training programs in all over India. Empowering local talent with global technology standards.',
  keywords: 'JankiInfotech, web development Bihar, mobile app development, cloud solutions, DevOps, training programs, internship Bihar, IT company Bihar, software development',
  ...
  switch (type) {
    case 'organization':
      return {
        ...
        description: 'Leading IT solutions and training company in Bihar, India. Specializing in web development, mobile apps, cloud solutions, and professional training programs.',
        address: {
          '@type': 'PostalAddress',
    ...
    case 'website':
      return {
        ...
        name: 'JankiInfotech',
        url: baseUrl,
        description: 'Leading IT solutions and training company in Bihar, India.',
        publisher: {
          '@type': 'Organization',
          name: 'JankiInfotech'
        },
    ...
    case 'service':
      return {
        ...
        description: data.description || 'Professional IT solutions and services',
        provider: {
          '@type': 'Organization',
          name: 'JankiInfotech',
          url: baseUrl

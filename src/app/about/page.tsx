...
export default function AboutPage() {
  ...
  const stats = [
    ...
    { icon: TrendingUp, value: "150+", label: "Projects Completed", color: "text-green-600" },
    { icon: Award, value: "50+", label: "Awards Won", color: "text-purple-600" },
    { icon: Globe, value: "15+", label: "Countries Served", color: "text-orange-600" },
  ];
  ...
  const values = [
    ...
    },
    {
      ...
      description: "Your data and projects are secure with us. We maintain the highest standards of security and confidentiality.",
  ...
  const milestones = [
    ...
    { year: "2023", title: "500+ Success Stories", description: "Helped over 500 students and businesses achieve their goals" },
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
              We are a passionate team of innovators, developers, and dreamers committed to 
              empowering businesses and individuals through cutting-edge technology solutions.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            {activeTab === "mission" && (
              <div className="text-center animate-fadeIn">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  To democratize technology and make it accessible to everyone. We believe that 
                  every business, regardless of size, deserves world-class digital solutions. 
                  Our mission is to bridge the technology gap and empower our clients with 
                  innovative tools that drive growth and success.
                </p>
              </div>
            )}
            ...
            {activeTab === "vision" && (
              <div className="text-center animate-fadeIn">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  To become the leading technology partner in Bihar and beyond, known for 
                  innovation, quality, and social impact. We envision a future where technology 
                  serves humanity, creates opportunities, and builds a more connected and 
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  {values.map((value, index) => (
                    <div key={index} className="bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
                      <div className={`w-12 h-12 bg-gradient-to-r ${value.gradient} rounded-full flex items-center justify-center mb-4`}>

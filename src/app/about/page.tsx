            ...
            <div className="max-w-4xl mx-auto">
              {activeTab === "mission" && (
                <div className="text-center animate-fadeIn">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    To democratize technology and make it accessible to
                    everyone. We believe that every business, regardless of
                    size, deserves world-class digital solutions. Our mission is
                    to bridge the technology gap and empower our clients with
              ...
              {activeTab === "vision" && (
                <div className="text-center animate-fadeIn">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    To become the leading technology partner in Bihar and
                    beyond, known for innovation, quality, and social impact. We
                    envision a future where technology serves humanity, creates

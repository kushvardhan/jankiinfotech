...
const projects: Project[] = [
  {
    ...
    fullDescription: "A comprehensive healthcare platform dedicated to making traditional Naturopathy & Ayurvedic healing accessible to all. Ayurakshak is a registered NGO providing natural healthcare solutions to 10,000+ patients across India through 55+ hospitals and 70+ clinics.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "A registered charitable trust providing quality education and welfare support to underprivileged children in Bihar. Cambridge Trust has impacted 500+ children through 10+ school partnerships and comprehensive social welfare programs.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "A stunning portfolio website for a professional mehandi artist in Noida with 10+ years of experience. Features an extensive gallery of 500+ designs, online booking system, and client testimonials showcasing expertise in Arabic, Rajasthani, and modern mehandi styles.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "A professional website for a traditional mehandi artist in Motihari with 12+ years of experience and 2000+ happy clients. Features a beautiful gallery, service showcase, and easy booking system for bridal, Arabic, and custom mehandi designs.",
    features: [
      ...
      <section className="relative min-h-[35vh] bg-gradient-to-br from-green-50 to-white flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 md:pt-28 pb-8">
        <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
            Transforming ideas into impactful digital solutions that drive real business results
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mt-12 text-center">
            <div className="inline-block bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6 md:p-8 border border-green-200">
              <p className="text-gray-700 font-medium mb-2">🚀 More Websites Under Development</p>
              <p className="text-sm text-gray-600">
                We're constantly working on exciting new projects. Stay tuned for more amazing digital solutions!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full my-8">
            <div className="p-6 md:p-8">
              ...
              <div className="flex items-center gap-2 text-gray-700 mb-6 text-sm">
                <Calendar className="h-4 w-4 text-green-600" />
                <span className="font-medium">Development Time: {selectedProject.duration}</span>
              </div>
      ...
      <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-green-50">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-6">
            These projects were crafted with passion and precision by our talented development team. Each website represents our commitment to delivering exceptional digital solutions that make a real impact.
          </p>
          <div className="inline-block bg-white rounded-lg p-6 border border-green-200 shadow-sm">
            ...
            <p className="text-xs text-gray-500 mt-1">kushvardhan39797@gmail.com</p>
          </div>
        </div>
      </section>

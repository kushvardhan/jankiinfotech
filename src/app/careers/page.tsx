          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
                Join a team of passionate innovators who are transforming the
                tech landscape in Bihar and beyond. Grow your skills, make an
                impact, and build something meaningful.
              </p>

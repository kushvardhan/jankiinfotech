...
export default function CommunityPage() {
  ...
  const upcomingEvents = [
    ...
    },
    {
      ...
      attendees: 80,
      description:
        "Present your startup ideas to investors and get valuable feedback.",
      image: "💡",
    },
  ];
  ...
  const communityHighlights = [
    {
      ...
      description:
        "Our community members have landed jobs at top tech companies",
      icon: Star,
      count: "95%",
  ...
  const testimonials = [
    {
      ...
      image: "👩‍💻",
      quote:
        "The JankiInfotech community helped me transition from a non-tech background to landing my dream job in just 8 months!",
    },
    {
      name: "Rahul Kumar",
      ...
      image: "👨‍💼",
      quote:
        "The networking opportunities and mentorship I received here were invaluable for starting my own tech company.",
    },
    {
      name: "Anjali Singh",
      ...
      image: "👩‍🔬",
      quote:
        "From learning basics to advanced concepts, this community supported me throughout my journey in data science.",
    },
  ];
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
                Join a vibrant community of developers, entrepreneurs, and tech
                enthusiasts. Learn from experts, collaborate on projects, and
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Discover the benefits of being part of our thriving tech
                community
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-green-600 to-green-700">
          <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-green-100 mb-8">
              Connect with like-minded individuals and accelerate your tech
              journey
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

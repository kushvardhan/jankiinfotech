      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            {teamImages.map((image, index) => (
              <div key={index} className="aspect-square bg-gray-200 rounded-xl overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center">
                  <span className="text-gray-500 text-sm">Team Image {index + 1}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Years of Excellence</h4>
            </div>

            <div>
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Our Vision</h4>
              <p className="text-gray-600 leading-relaxed mb-6">
                To create a world-class tech hub, combining traditional values with modern innovation. 
                We're building more than just a company - we're nurturing a tech ecosystem that empowers 
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-12 text-white text-center mb-20">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Be part of a transformative movement that's putting innovation on the global tech map. 

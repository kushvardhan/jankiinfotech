...
const countries: Country[] = [
  { code: 'IN', name: 'India', dialCode: '+91', flag: '🇮🇳', pattern: /^[6-9]\d{9}$/, placeholder: '9876543210' },
  { code: 'US', name: 'United States', dialCode: '+1', flag: '🇺🇸', pattern: /^\d{10}$/, placeholder: '2345678901' },
  { code: 'GB', name: 'United Kingdom', dialCode: '+44', flag: '🇬🇧', pattern: /^[1-9]\d{8,9}$/, placeholder: '7911123456' },
  { code: 'CA', name: 'Canada', dialCode: '+1', flag: '🇨🇦', pattern: /^\d{10}$/, placeholder: '2345678901' },
  { code: 'AU', name: 'Australia', dialCode: '+61', flag: '🇦🇺', pattern: /^[2-9]\d{8}$/, placeholder: '412345678' },
  { code: 'DE', name: 'Germany', dialCode: '+49', flag: '🇩🇪', pattern: /^[1-9]\d{10,11}$/, placeholder: '15123456789' },
  { code: 'FR', name: 'France', dialCode: '+33', flag: '🇫🇷', pattern: /^[1-9]\d{8}$/, placeholder: '123456789' },
  { code: 'JP', name: 'Japan', dialCode: '+81', flag: '🇯🇵', pattern: /^[1-9]\d{9,10}$/, placeholder: '9012345678' },
  { code: 'CN', name: 'China', dialCode: '+86', flag: '🇨🇳', pattern: /^1[3-9]\d{9}$/, placeholder: '13812345678' },
  { code: 'BR', name: 'Brazil', dialCode: '+55', flag: '🇧🇷', pattern: /^[1-9]\d{10}$/, placeholder: '11987654321' },
  { code: 'SG', name: 'Singapore', dialCode: '+65', flag: '🇸🇬', pattern: /^[689]\d{7}$/, placeholder: '81234567' },
  { code: 'AE', name: 'UAE', dialCode: '+971', flag: '🇦🇪', pattern: /^[2-9]\d{7,8}$/, placeholder: '501234567' },
]

  ...
  const workflowSteps = [
    {
      ...
      description:
        "We start by understanding your business needs and defining clear project scope and requirements.",
    },
    {
      icon: "🔍",
      ...
      description:
        "Thorough market research and competitive analysis to ensure optimal solution design.",
    },
    {
      icon: "👥",
      ...
      description:
        "Dedicated team of experts assigned based on project requirements and technology stack.",
    },
    {
      icon: "🎨",
      title: "Design",
      ...
      description:
        "Creating intuitive and engaging user interfaces with focus on user experience.",
    },
    {
      icon: "⚙️",
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block">
          <div className="relative">
            {/* Connection Line */}
            <div className="absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-green-200 via-green-400 to-green-600 transform -translate-y-1/2 z-0"></div>
            ...
            <div className="grid grid-cols-6 gap-4 relative z-10">
              {workflowSteps.map((step, index) => (
                <div key={index} className="text-center">
                  {/* Icon Circle */}
                  <div className="w-20 h-20 bg-white border-4 border-green-600 rounded-full flex items-center justify-center text-3xl mx-auto mb-4 shadow-lg">
                    {step.icon}
                  </div>
          ...
          <div className="space-y-8">
            {workflowSteps.map((step, index) => (
              <div key={index} className="flex items-start space-x-4">
                {/* Icon */}
                <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center text-2xl text-white flex-shrink-0">
                  {step.icon}
                </div>

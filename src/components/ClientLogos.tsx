    ...
    <section className="relative py-20 bg-gradient-to-br from-purple-50 via-white to-blue-50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          {/* “More” indicator (for desktop and mobile) */}
          {/* For large screens (desktop, no scroller) */}
          <div className="hidden lg:flex items-center justify-center gap-3 text-gray-600 text-sm font-medium mt-10 mb-12">
            <span className="block h-[1px] w-16 bg-gradient-to-r from-transparent via-gray-300 to-transparent"></span>
            <span className="relative uppercase tracking-[0.2em] bg-white/80 dark:bg-white/10 backdrop-blur-md px-6 py-2 rounded-full border border-gray-200 dark:border-white/20 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_14px_rgba(0,0,0,0.08)] transition-all duration-500 ease-out group">
              <span className="text-gray-700 dark:text-gray-200">More</span>
              <span className="absolute inset-0 rounded-full bg-gradient-to-r from-green-500/10 via-blue-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </span>
            <span className="block h-[1px] w-16 bg-gradient-to-r from-transparent via-gray-300 to-transparent"></span>
          </div>
          ...
          <div className="md:hidden relative">
            ...
            <div className="flex lg:hidden items-center justify-center mt-8 mb-8">
              <span className="text-gray-500 text-xs tracking-wider bg-white/70 dark:bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full border border-gray-200 dark:border-white/20 shadow-sm animate-pulse">
                more
              </span>
            </div>
          </div>
